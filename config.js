...
//    from http://api.coindesk.com/v1/bpi/supported-currencies.json
exports.SUPPORTED_CURRENCIES = [
  ...
  'MAD', 'MDL', 'MGA', 'MKD', 'MMK', 'MNT', 'MOP', 'MRO', 'MTL', 'MUR', 'MVR',
  ...
  'XAF', 'XAG', 'XAU', 'XBT', 'XCD', 'XDR', 'XOF', 'XPF', 'YER', 'ZAR', 'ZMK',
  'ZMW', 'ZWL'];

exports.API_ENDPOINT = 'https://api.coindesk.com/v1/bpi/';
